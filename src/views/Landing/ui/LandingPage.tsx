...
const LandingPage = () => {
  return (
    <div className="flex flex-col gap-3 pt-8 pb-7.5 px-6 h-full w-full">
      ...
      <section className="flex flex-col items-start py-4 pl-5 w-full bg-sky-50 rounded-xl">
        <span className="font-semibold text-gray-500 text-sm">
          다양한 컨셉 별
        </span>
        <span className="font-bold text-lg">찐 맛집 탐색</span>
      </section>
      <section className="flex flex-col items-start py-4 pl-5 w-full bg-purple-50 rounded-xl">
        <span className="font-semibold text-gray-500 text-sm">
          입맛에 딱 맞는
        </span>
        <span className="font-bold text-lg">나만의 맛집 수집</span>
      </section>
      <section className="flex flex-col items-start py-4 pl-5 w-full bg-green-50 rounded-xl">
        <span className="font-semibold text-gray-500 text-sm">
          한 눈에 보기 편한
        </span>
